    ...
    <div className="card-body">
      <form action="/" onSubmit={(e) => this.handleSubmit(e)} encType="multipart/form-data" autoComplete="off">
        <div className="form-group">
          ...
          <input name="name" type="text" className="form-control" placeholder="Your Name" value={this.state.name} onChange={this.handleChange} onBlur={this.handleBlur} />
          { nameError
        ...
        <div className="form-group">
          ...
          <input name="email" type="email" className="form-control" placeholder="Your Email" value={this.state.email} onChange={this.handleChange} onBlur={this.handleBlur} />
          { emailError
        ...
        <div className="form-group">
          ...
          <input name="contact" type="text" className="form-control" placeholder="Contact Number (Optional)" onChange={this.handleChange} value={this.state.contact}  />
        </div>
        <div className="form-group">
          {/* <label className="mb-0">Message<span className="text-danger">*</span></label> */}
          <textarea name="message" type="text" className="form-control" placeholder="Your Message" value={this.state.message} onChange={this.handleChange} onBlur={this.handleBlur} />
          { messageError
            ? <div className="alert alert-danger mt-2">Message is a required field.</div>
            : ''
          }
        </div>
          <p className="text-center mb-0"><input type="submit" className=" btn btn-outline-success w-100 text-uppercase" value="Send" /></p>
      </form>
